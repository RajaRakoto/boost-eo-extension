export const bbeo_pattern = {
	...
	"[pattern]: This snippet removes duplicate values in an array": {
		...
		description: "[pattern]: This snippet removes duplicate values in an array",
	},
	...
	"[pattern]: This snippet returns the last element of an array": {
		...
		description: "[pattern]: This snippet returns the last element of an array",
	},
	...
	"[pattern]: This snippet can be used to get the earliest date": {
		...
		description: "[pattern]: This snippet can be used to get the earliest date",
	},
