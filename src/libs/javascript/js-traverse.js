export const js_traverse = {
	...
	'[libs]: Get all key value from external object': {
		prefix: 'bbeo-js-libs-traverse-traverseKeyValueByObject',
		body: [
		...
		description: '[libs]: Get all key value from external object',
	},
	'[libs]: Get all key value from external JSON file': {
		prefix: 'bbeo-js-libs-traverse-traverseKeyValueByJSON',
		body: [
		...
		description: '[libs]: Get all key value from external JSON file',
	},
};
